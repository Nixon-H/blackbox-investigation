...
![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/czwrxwudopwdow3611un.png)

Wait... Kimi is a model by Moonshot AI, not OpenAI!

**Test 2; Minimax selected.** Same question:

![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/t5zdu8fuqd6kuo4zkf1a.png)

> *"Created by OpenAI. Model: OpenAI 'o4-mini' (via ChatGPT system)."*

The same response again. Both Kimi and Minimax returned identical answers claiming to be OpenAI's o4-mini. Two different model selections, same fake identity.
